...
<div className={`${isOpen? 'translate-x-[0%]':'translate-x-[100%]'} top-30 right-0 duration-200 max-w-screen-xl px-4 mx-auto z-20 sm:px-6 lg:px-8`}>
...
items?.map((product)=>(
 ...
 />
        ...
        <div className="px-6 py-8 bg-white  lg:flex-shrink-1 lg:p-12 w-full">
